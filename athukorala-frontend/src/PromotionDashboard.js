...
import { Plus, Tag, Trash2, Power, X, Calendar, Percent, Sparkles, TrendingUp, CheckCircle, PowerOff, AlertTriangle, Briefcase, Box, Edit3 } from 'lucide-react';
          ...
          >
            ...
            <div className="flex gap-3 opacity-0 group-hover:opacity-100 transition-all text-gray-400">
              <button 
                ...
                className="p-4 bg-white/5 text-gray-400 hover:text-yellow-500 rounded-xl transition-all magnetic-reactive"
              >
                <Edit3 size={20}/>
              </button>
